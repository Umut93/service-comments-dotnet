...
namespace Unik.Comments.Infrastructure.Migrations
{
    ...
    [Migration("20220516100525_comments")]
            ...
            modelBuilder.Entity("Unik.Comments.Infrastructure.Models.CommentEntity", b =>
                {
                    ...
                    b.Property<int?>("ParrentInternalId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Unik.Comments.Infrastructure.Models.CommentEntity", b =>
                {
                    ...
                    b.HasOne("Unik.Comments.Infrastructure.Models.CommentEntity", "Parrent")
                        .WithMany("Replies")
                        .HasForeignKey("ParrentInternalId");
